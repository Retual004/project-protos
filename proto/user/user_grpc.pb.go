...
type UserServiceClient interface {
	...
	GetUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*GetUserResponse, error)
...
func (c *userServiceClient) GetUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*GetUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *User) (*GetUserResponse, error) {
