...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	0,  // 6: user.UserService.GetUser:input_type -> user.User
	...
	9,  // 9: user.UserService.ListUsers:input_type -> google.protobuf.Empty
